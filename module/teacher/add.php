...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Nama Guru</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href=".">Home</a></li>
                    <li class="breadcrumb-item active">Nama Guru</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header row">
                        <div class="card-title h3 col-8">Tambah Nama Guru</div>
                        <div class="col-4">
                    ...
                    <div class="card-body">
                        <form action="?m=subject&s=save" method="post">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="subject" class="form-control" placeholder="Nama Guru*" required autofocus>
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-user-clock"></i></span>
                                </div>
                                <input type="text" name="hour" class="form-control" placeholder="Mata Pelajaran*" maxlength="2" required>
                            </div>
                            <div class="input-group mb-3">
